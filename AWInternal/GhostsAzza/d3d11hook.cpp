...
HRESULT __stdcall PresentHook(IDXGISwapChain* pSwapChain, UINT SyncInterval, UINT Flags)
{
	std::call_once(g_isInitialized, [&]() {
		...
		ImGui_ImplDX11_Init(hWnde, g_pd3dDevice, g_pd3dContext);
		inputHook.Init(hWnde);
	});
...
void InitTheme(ImGuiStyle & style)
{
	...
	style.Colors[ImGuiCol_Tab] = ImVec4(0.737f, 0.863f, 0.957f, 1.00f);
	style.Colors[ImGuiCol_TabActive] = ImVec4(0.851f, 0.922f, 0.976f, 1.00f);
	style.Colors[ImGuiCol_TabHovered] = ImVec4(0.851f, 0.922f, 0.976f, 1.00f);
	//style.Colors[ImGuiCol_TabUnfocused] = ImVec4(0.851f, 0.922f, 0.976f, 1.00f);
	//style.Colors[ImGuiCol_TabUnfocusedActive] = ImVec4(0.737f, 0.863f, 0.957f, 1.00f);
	...
	style.Colors[ImGuiCol_BorderShadow] = ImVec4(0.7f, 0.7f, 0.7f, 1.00f);
	style.Colors[ImGuiCol_FrameBg] = ImVec4(1.0f, 1.0f, 1.0f, 1.00f);
	style.Colors[ImGuiCol_FrameBgHovered] = ImVec4(1.000f, 1.000f, 0.882f, 1.000f);
	style.Colors[ImGuiCol_FrameBgActive] = ImVec4(1.000f, 1.000f, 0.882f, 1.000f);
	style.Colors[ImGuiCol_TitleBg] = ImVec4(0.6f, 0.7f, 0.8f, 1.00f);
	style.Colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.6f, 0.7f, 0.8f, 1.00f);
	style.Colors[ImGuiCol_TitleBgActive] = ImVec4(0.6f, 0.7f, 0.8f, 1.00f);
	style.Colors[ImGuiCol_MenuBarBg] = ImVec4(0.05f, 0.05f, 0.05f, 1.00f);
	style.Colors[ImGuiCol_ScrollbarBg] = ImVec4(0.10f, 0.09f, 0.12f, 1.00f);
	style.Colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.80f, 0.80f, 0.83f, 0.31f);
	style.Colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(1.0f, 1.0f, 0.9f, 1.00f);
	style.Colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.06f, 0.05f, 0.07f, 1.00f);
	style.Colors[ImGuiCol_ComboBg] = ImVec4(0.19f, 0.18f, 0.21f, 1.00f);
	style.Colors[ImGuiCol_CheckMark] = ImVec4(0.80f, 0.80f, 0.83f, 0.31f);
	style.Colors[ImGuiCol_SliderGrab] = ImVec4(1.0f, 1.0f, 0.9f, 1.00f);
	style.Colors[ImGuiCol_SliderGrabActive] = ImVec4(1.0f, 1.0f, 0.9f, 1.00f);
	style.Colors[ImGuiCol_Button] = ImVec4(0.75f, 0.75f, 0.75f, 1.00f);
	style.Colors[ImGuiCol_ButtonHovered] = ImVec4(0.8f, 0.8f, 1.0f, 1.00f);
	style.Colors[ImGuiCol_ButtonActive] = ImVec4(0.9f, 0.9f, 1.0f, 1.00f);
	...
	//style.Colors[ImGuiCol_DockingEmptyBg] = ImVec4(0.90f, 0.90f, 0.90f, 1.00f);
}

DWORD __stdcall HookDX11_Init()
{
	
	hWnde = *(HWND*)0x147AD2640;
	...
	DXGI_SWAP_CHAIN_DESC sd;
	{
		...
		sd.OutputWindow = hWnde;
		sd.SampleDesc.Count = 1;
		sd.Windowed = ((GetWindowLongPtr(hWnde, GWL_STYLE) & WS_POPUP) != 0) ? FALSE : TRUE;
		sd.BufferDesc.ScanlineOrdering = DXGI_MODE_SCANLINE_ORDER_UNSPECIFIED;
		sd.BufferDesc.Scaling = DXGI_MODE_SCALING_UNSPECIFIED;
	...
	if (FAILED(hr))
	{
		MessageBox(hWnde, "Failed to create device and swapchain.", "Fatal Error", MB_ICONERROR);
		return E_FAIL;
	}
